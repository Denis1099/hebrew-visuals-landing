...
const Portfolio = () => {
  ...
  return (
    <div className="min-h-screen bg-[radial-gradient(circle_at_50%_50%,rgba(255,255,255,0.81),rgba(191,135,239,0.81))] relative">
      <Navbar />
      
      <div className="pt-24 pb-12">
        <h1 className="text-4xl font-migdal text-[#6b46c1] text-center mb-12">
          הפורטפוליו שלי
        </h1>
