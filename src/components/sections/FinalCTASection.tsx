const FinalCTASection = () => {
  return (
    <section id="final-cta" className="py-20 bg-gradient-to-b from-white via-[#805ad5] to-[#6b46c1] text-white">
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="space-y-6 text-lg">
            ...
            <p className="text-2xl font-bold text-blue-300">אבל תן לי לשאול אותך –</p>
            ...
            <p className="text-2xl font-bold text-blue-300">אני שואל אותך,</p>
            <p>איזה סוג של בעל עסק אתה רוצה להיות?</p>
            <p>האם אתה מוכן לשים את הפחדים בצד ולהפוך למוביל בשוק שלך?</p>
            <p className="text-2xl font-bold text-blue-300">הבחירה בידיים שלך.</p>
