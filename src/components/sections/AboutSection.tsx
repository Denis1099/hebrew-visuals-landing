      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-4 md:space-y-6 text-center  text-lg">
            ...
            <p>הייתי גם אני שם – ביישן, לא יודע איך לעמוד מול המצלמה ובעיקר תקוע שיווקית. מאז עברו מים בנהר ובעיקר הפסדתי המון זמן שעלה לי בהמון כסף שיכלתי להרוויח אם הייתי מבין את זה מוקדם יותר.</p>
