      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-4 md:space-y-6 text-center text-lg">
            ...
            מאז שאני זוכר את עצמי או אם לדייק מאז גיל 10 שלקחתי את המצלמה הישנה של אחי הגדול לא עזבתי אותה, בשלב מסוים הבנתי שוידאו מעבר לזה שזה עושה לי את זה</p>
            <p>זה אשכרה מביא תוצאות ומשנה מציאות לבעלי עסקים!</p>
