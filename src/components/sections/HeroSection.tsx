    ...
    <section id="home" className="min-h-screen flex items-start pt-32 bg-gradient-primary text-white">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row items-start justify-between gap-8 md:gap-12">
          <div className="w-full md:w-1/2 text-center md:text-right space-y-4 md:space-y-6 animate-fade-in">
            ...
            <div className="block md:hidden">
              <img 
                ...
                alt="תמונת גיבור"
                className="w-[85%] h-auto rounded-2xl shadow-xl mx-auto mb-6"
              />
            </div>
