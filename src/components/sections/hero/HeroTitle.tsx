    ...
    <div className="text-center">
      ...
      <div className="relative mb-4 md:mb-8 flex justify-center">
        <div className="flex items-start">
          ...
          <div className="mx-1">
            <div className="text-5xl sm:text-4xl md:text-6xl lg:text-8xl text-[#c6008a] font-migdal">
              אני האמיתי
            </div>
            <div className="text-5xl sm:text-4xl md:text-6xl lg:text-8xl text-[#004aad] font-migdal">
              בעסק שלך
            </div>
          </div>
          <span className="text-5xl md:text-6xl lg:text-8xl leading-none text-[#c6008a]">"</span>
